...
facilityInfo = {
    0:  ['gate1',          'Gate',      30,  350, 500,   60,  16, 20000],
    1:  ['gate2',          'Gate',      280, 550, 500,   60,  16, 20000],
    2:  ['restroom1',      'Restroom',  130, 350, 20,    3,  1, 3000],
    3:  ['restaurant1',    'Food',      280, 350, 50,    15, 4, 6000],
    4:  ['store1',         'Shopping',  380, 350, 10,    3,  1, 5000],
    5:  ['restaurant2',    'Food',      450, 350, 20,    10, 4, 6000],
    6:  ['restroom2',      'Restroom',  550, 350, 10,    2,  1, 3000],
    7:  ['restroom3',      'Restroom',  280, 480, 15,    2,  1, 3000],
    8:  ['store2',         'Shopping',  380, 220, 15,    5,  1, 5000],
    9:  ['restaurant3',    'Food',      450, 280, 40,    10, 4, 6000],
    10: ['baggage claim1', 'BC',        670, 290, 300,   20, 4, 30000],
    11: ['baggage claim2', 'BC',        670, 390, 300,   19, 4, 30000],
    12: ['exit',           'Exit',      750, 350, 10000, 0,  0, 50000],
    13: ['counter1',       'Counter',   190, 50,  None,   None,  None, 1000],
    14: ['counter2',       'Counter',   270, 50,  None,   None,  None, 1000],
    15: ['counter3',       'Counter',   350, 50,  None,   None,  None, 1000],
    16: ['security1',      'Security',  190, 150, None,   None,  None, 1000],
    17: ['security2',      'Security',  270, 150, None,   None,  None, 1000],
    18: ['security3',      'Security',  350, 150, None,   None,  None, 1000]
}
